 ...
 */
//bao tri website
// $route['default_controller'] = 'error_page/index';
// $route['(:any)'] = 'error_page/index';
//
...
$route['change-password'] = 'jobseeker/jobseeker/changePassword';
$route['jobseeker/gerFormCreateResume'] = 'jobseeker/jobseeker/getFormCreateResume';
$route['create-resume'] = 'jobseeker/jobseeker/createResumeForm';
$route['jobseeker/create-resume'] = 'jobseeker/jobseeker/createResume';
$route['upload-resume'] = 'jobseeker/jobseeker/uploadResumeForm';
$route['jobseeker/upload-resume'] = 'jobseeker/jobseeker/uploadResume';
$route['jobseeker/delete-recruitment/(:num)'] = 'jobseeker/jobseeker/deleteRecruitmentApply/$1';
$route['jobseeker/delete-resume-upload/(:num)'] = 'jobseeker/jobseeker/deleteResumeUpload/$1';
$route['jobseeker/delete-resume-online/(:num)'] = 'jobseeker/jobseeker/deleteResumeOnline/$1';
$route['jobseeker/detail-resume/(:num)'] = 'jobseeker/jobseeker/getDetailForm/$1';
$route['jobseeker/edit-resume/(:num)'] = 'jobseeker/jobseeker/getEditlForm/$1';
$route['jobseeker/edit-resume-post'] = 'jobseeker/jobseeker/editResume';
...
$route['employer/resume/store'] = 'employer/employer_resume/store';
$route['employer/resume/search/(:any)_(:any)_(:any)'] = 'employer/employer_resume/search/$1/$2/$3';
$route['employer/resume/search/(:any)_(:any)_(:any)/(:num)'] = 'employer/employer_resume/search/$1/$2/$3';
$route['employer/resume/search/(:any)'] = 'employer/employer_resume/search/$1';
$route['employer/resume/search/(:any)/(:num)'] = 'employer/employer_resume/search/$1';
$route['employer/resume/detail/(:any)-(:num)'] = 'employer/employer_resume/detail/$2';
$route['employer/resume/store-resume/(:num)'] = 'employer/employer_resume/storeResume/$1';
$route['employer/resume/delete-store/(:num)'] = 'employer/employer_resume/deleteStoreResume/$1';
