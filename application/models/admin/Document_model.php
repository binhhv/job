...
class Document_model extends CI_Model {
	...
	function insertJobseeker($dataJobseeker) {
		$output = $this->dbutil->insertDb($dataJobseeker, 'jobseeker');
		$code = $this->util->General_Code('jobseeker', $output, 0);
		$outputupdate = $this->util->update_Code('jobseeker', 'jobseeker_code', $code, 'jobseeker_id', $output);
		return $output;
	}
