...
<title>Group | Trang chu</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">

<!-- CSS
================================================== -->
<link href='http://fonts.googleapis.com/css?family=Oswald' rel='stylesheet' type='text/css'>
<link rel="stylesheet" href="<?php echo base_url()?>assets/view2/bootstrap/dist/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=Montserrat">
<link rel="stylesheet" href="<?php echo base_url();?>assets/view2/font-awesome/css/font-awesome.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/view2/css/style.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/view2/css/responsive-style.css">
<!-- <link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/view1/css/style4189.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/view1/flexslider/flexslider.css"> -->
...
<script src="<?php echo base_url()?>/assets/view2/bootstrap/dist/js/bootstrap.min.js"></script>
<!--<script src="<?php echo base_url()?>/assets/view1/flexslider/jquery.flexslider.js"></script>
<script src="<?php echo base_url()?>/assets/view1/js/job7vn.js"></script>-->
 <script type="text/javascript" src="https://maps.google.com/maps/api/js?sensor=true"></script>
<!--<script src="<?php echo base_url()?>/assets/view1/js/jquery4a80.js"></script>-->
