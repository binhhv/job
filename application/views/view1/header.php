				...
				<div class="container">
					<a href="index.html" title="Jobify Darker" rel="home" class="site-branding">
						<h1 class="site-title">
							<img src="<?php if(isset($logo)) echo base_url().'assets/view1/'.$logo?>" width="<?php if(isset($logoWidth)) echo $logoWidth; ?>" height="<?php if(isset($logoHeight)) echo $logoHeight; ?>" alt="JOB7VN">
							<span <?php if(isset($showTitle) && $showTitle) echo 'class="web-title"' ?>>JOB7VN</span>
						</h1>
	...
	<div class="menu-main-menu-container">
		<ul id="menu-main-menu" class="nav-menu-primary">
			...
			<li id="menu-item-2075" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children  menu-item-2075"><a href="<?php echo base_url('loadview') ?>">JOB7VN<i class="icon-dropdown"></i></a>
				<ul class="sub-menu">
					<li id="menu-item-2076" class="menu-item menu-item-type-taxonomy menu-item-object-job_listing_region menu-item-2076"><a href="job-region/san-francisco/index.html">Mục đích thành lập</a></li>
	...
	<li id="menu-item-2075" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children  menu-item-2075"><a href="find-a-job/index.html">Việc làm<i class="icon-dropdown"></i></a>
			<ul class="sub-menu">
				<li id="menu-item-2076" class="menu-item menu-item-type-taxonomy menu-item-object-job_listing_region menu-item-2076"><a href="job-region/san-francisco/index.html">Việc làm miền Bắc</a></li>
				<li id="menu-item-2077" class="menu-item menu-item-type-taxonomy menu-item-object-job_listing_region menu-item-2077"><a href="job-region/palo-alto/index.html">Việc làm miền Trung</a></li>
				<li id="menu-item-2148" class="menu-item menu-item-type-taxonomy menu-item-object-job_listing_region menu-item-2148"><a href="job-region/san-jose/index.html">Việc làm miền Nam</a></li>
			</ul>
	</li>
	...
	<li id="menu-item-6454" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6454"><a href="post-a-resume/index.html">Việc làm miền Nam</a></li>
	 -->
	<li id="menu-item-2788" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2788"><a href="find-a-candidate/index.html">Contact us</a></li>
	...
	<li id="register-modal" class="register menu-item menu-item-type-post_type menu-item-object-page menu-item-1945"><a href="sign-up/index.html">Register/Login</a></li>
	...
	<li id="menu-item-2075" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children  menu-item-2075"><a href="find-a-job/index.html">English<i class="icon-dropdown"></i></a>
			<ul class="sub-menu">
