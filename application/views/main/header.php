	...
	echo base_url() . 'assets/view1/' . $logo;
}
...
?>>JOB7VN</span>
	...
	<li id="register-modal" class="register menu-item menu-item-type-post_type menu-item-object-page menu-item-1945"><a href="sign-up/index.html">Register</a></li>
	<li id="register-modal" class="register menu-item menu-item-type-post_type menu-item-object-page menu-item-1945"><a href="sign-up/index.html">Login</a></li>
