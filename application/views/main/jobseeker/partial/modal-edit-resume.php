    ...
    ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        id="phone" placeholder="số điện thoại" name="phone" value="<?php echo $resume->docon_phone;?>" />
                    </div>
...
?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control"
                        id="email" placeholder="bằng cấp/giấy chứng nhận" name="degree" value="<?php echo $resume->docon_degree;?>" />
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control"
                        id="email" placeholder="học vấn" name="education" value="<?php echo $resume->docon_education;?>" />
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control"
                        id="email" placeholder="nơi ở" name="address" value="<?php echo $resume->docon_address;?>"/>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control"
                        id="email" placeholder="kinh nghiệm" name="experience" value="<?php echo $resume->docon_experience;?>" />
                    </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea placeholder="sở thích/kỹ năng" name="skill"  id="skill" class="form-control" tabindex="3" rows="3" cols="50"
...
?>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-8">
                         <textarea placeholder="lý do ứng tuyển" name="reason-apply"  id="reason-apply" class="form-control" tabindex="3" rows="3" cols="50"
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control"
                        id="email" placeholder="mức lương" name="salary" value="<?php echo nl2br($resume->docon_salary);?>"/>
                    </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-8">
                           <textarea placeholder="vấn đề khác" name="advance"  id="advance" class="form-control" tabindex="3" rows="3" cols="50"
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-8">
                         <textarea  name="wish"  placeholder="nguyện vọng" id="wish" class="form-control" tabindex="3" rows="3" cols="50" value="<?php echo nl2br($resume->docon_wish);?>"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
