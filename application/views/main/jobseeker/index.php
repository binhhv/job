...
?></span> <span class="lh-20 dp-block text-right"><a class="btn btn-xs btn-danger" href="<?php echo base_url('logout')?>">Đăng xuất</a></span></td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 "><button class="btn btn-sm btn-primary btn-resume"><i class="fa fa-pencil-square-o"></i>Tạo hồ sơ mới</button></div>
                            <div class="col-sm-12"><button class="btn btn-sm btn-primary btn-resume"><i class="fa fa-cloud-upload"></i>Tải lên hồ sơ</button></div>
                        </div>
                    </div>
                    <!--  <div class="row">
                        <div class="col-sm-12">
                         ...
                         <div class="row">
                            ...
                            <!-- <div class="col-sm-12"> -->
                                <div class="form-group">
                                     ...
                                     <div class="col-sm-8 col-sm-offset-4 hide text-right margin-top-5 error-old-password">
                            ...
                            <!-- <div class="col-sm-12"> -->
                                <div class="form-group">
                                     ...
                                     <div class="col-sm-7">
                                      ...
                                      <div class="col-sm-8 col-sm-offset-4 hide text-right margin-top-5 error-new-password">
                             ...
                             <!-- <div class="col-sm-12"> -->
                                <div class="form-group">
                                     ...
                                     <div class="col-sm-7">
                                      ...
                                      <div class="col-sm-8 col-sm-offset-4 hide text-right margin-top-5 error-confirm-password">
