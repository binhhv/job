        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form" name="register-form" id="register-form" method="post" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 col-md-4 col-xs-4 control-label"><?php echo lang('first_name_re_user'); ?></label>
                        <div class="col-sm-8 col-md-8 col-xs-8">
                            <input type="text" class="form-control" name="account_first_name" />
                        </div>
                    </div>
                     <div class="form-group">
                        <label class="col-sm-4 col-md-4 col-xs-4 control-label"><?php echo lang('last_name_re_user'); ?></label>
                        <div class="col-sm-8 col-md-8 col-xs-8">
