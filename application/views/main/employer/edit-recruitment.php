<div class="card">
	<div class="row-employer row">
		...
		<div class="col-sm-12 clear mb_20 margin-top-10">
                                ...
                                <span class="text-color-1 title-jobseeker-register"><strong><?php echo lang('title_edit_recruitment_em'); ?></strong></span>
                            </div>
                             <form enctype="multipart/form-data" role="form" name="femployer-edit-recruitment" id="femployer-edit-recruitment" method="post">
			<div class="col-sm-12">
			<div class="form-group col-sm-12 error-em-info hide">
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control" name="title_recruitment" value="<?php if (isset($recruitment->rec_title)) {
	echo $recruitment->rec_title;
}
?>" />
                                    </div>
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="controls">
                                        ...
                                        <div class="row">
                                            <label class="col-sm-6"><input type="radio" value="1" <?php if (isset($recruitment) && $recruitment->rec_job_map_country == 1) {
	echo 'checked="true"';
}
?> name="country">Việt Nam</label>
                                            <label class="col-sm-6"><input type="radio" value="2" <?php if (isset($recruitment) && $recruitment->rec_job_map_country == 2) {
	echo 'checked="true"';
}
?> name="country">Nhật Bản</label>
                                ...
                                <select data-placeholder="<?php echo lang('s_chose_province'); ?>"  multiple class="chosen-select-vn form-control province-vn " tabindex="11" >
                                        <option value=""></option>
                                        <?php if (isset($provinceRecruitment) && $recruitment->rec_job_map_country == 1) {
	foreach ($provinceRecruitment as $key => $value) {
		?>
                                                <option <?php if ($value->isProvince != 0) {echo 'selected';}
...
?>
                                  ...
                                  <div class="select-province-jp hide">
                                    <select data-placeholder="<?php echo lang('s_chose_province'); ?>"  multiple class="chosen-select-jp form-control province-jp hide" tabindex="11" >
                                        <option value=""></option>
                                         <?php if (isset($provinceRecruitment) && $recruitment->rec_job_map_country == 2) {
	foreach ($provinceRecruitment as $key => $value) {
		?>
                                                <option <?php if ($value->isProvince != 0) {echo 'selected';}
		?> value="<?php echo $value->province_id ?>"><?php echo $value->province_name; ?></option>
...
?>
	...
	foreach ($listCareer as $key => $value) {
		?>
                                                ...
                                                <option <?php if ($value->career_id == $recruitment->rec_job_map_career) {echo 'selected';}
...
?>
	...
	foreach ($listSalary as $key => $value) {
		?>
                                                ...
                                                <option <?php if ($value->salary_id == $recruitment->rec_map_salary) {echo 'selected';}
...
?>
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <?php if (isset($welfareRecruitment)) {
	foreach ($welfareRecruitment as $key => $value) {
		?>
                                            <span class="welfare-detail-job">
                                                <label>
                                                    <input <?php if ($value->isWelfare) {echo 'checked="true"';}
		?> type="checkbox" value="<?php echo $value->welfare_id ?>" name="welfare[]">
...
?>
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control" name="time_work" id="time_work" value="<?php echo date('d/m/Y', strtotime($recruitment->rec_job_time)) ?>" />
                                    </div>
	...
	foreach ($listLevelJP as $key => $value) {
		?>
    <option <?php if ($value->ljob_id == $recruitment->rec_job_map_level) {echo 'selected';}
...
?>
	...
	foreach ($listJobForm as $key => $value) {
		?>
    <option <?php if ($value->fjob_id == $recruitment->rec_job_map_form) {echo 'selected';}
		?> value="<?php echo $value->fjob_id; ?>"><?php echo $value->fjob_type; ?></option>
                                                     <?php }
}
?>
                                             </select>
	...
	foreach ($listJobFormChild as $key => $value) {
		?>
    <option <?php if ($value->jcform_id == $recruitment->rec_job_map_form_child) {echo 'selected';}
		?> value="<?php echo $value->jcform_id; ?>"><?php echo $value->jcform_type; ?></option>
                                                     <?php }
}
?>
                                             </select>
                                 ...
                                 <div class="form-group col-sm-12">
                                    ...
                                    <div class="controls">
                                         <textarea type="text" class="form-control" name="content_recruitment"  rows="3" value ="<?php echo htmlspecialchars($recruitment->rec_job_content); ?>"> <?php echo htmlspecialchars($recruitment->rec_job_content); ?>
                                         </textarea>
                                    </div>
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <div class="controls">
                                         <textarea type="text" class="form-control" name="regimen_recruitment"  rows="3" value="<?php echo htmlspecialchars($recruitment->rec_job_regimen) ?>"><?php echo htmlspecialchars($recruitment->rec_job_regimen) ?>
                                         </textarea>
                                    </div>
                                       ...
                                       <div class="row">
                                         <div class="col-sm-6">
                                             <select name="sex-recruitment">
                                                <option <?php if ($recruitment->rec_job_require_sex == -1) {echo 'selected';}
?> value="-1">Không yêu cầu</option>
                                                <option <?php if ($recruitment->rec_job_require_sex == 0) {echo 'selected';}
?> value="0">Nữ</option>
                                                <option <?php if ($recruitment->rec_job_require_sex == 1) {echo 'selected';}
?> value="1">Nam</option>
                                             </select>
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <div class="controls">
                                         <textarea type="text" class="form-control" name="require_recruitment"  rows="3" value="<?php echo htmlspecialchars($recruitment->rec_job_require) ?>"> <?php echo htmlspecialchars($recruitment->rec_job_require) ?>
                                         </textarea>
                                    </div>
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <div class="controls">
                                         <textarea type="text" class="form-control" name="priority_recruitment"  rows="3" value=" <?php echo htmlspecialchars($recruitment->rec_job_priority) ?>"><?php echo htmlspecialchars($recruitment->rec_job_priority) ?>
                                         </textarea>
                                    </div>
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control" name="contact_name" value="<?php echo $recruitment->rec_contact_name; ?>"  />
                                    </div>
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control" name="contact_email" value="<?php echo $recruitment->rec_contact_email; ?>"  />
                                    </div>
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control" name="contact_address" value="<?php echo $recruitment->rec_contact_address; ?>" />
                                    </div>
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control" name="contact_phone" value="<?php echo $recruitment->rec_contact_phone; ?>" />
                                    </div>
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control" name="contact_mobile"  value="<?php echo $recruitment->rec_contact_mobile; ?>"/>
                                    </div>
	...
	foreach ($listContactForm as $key => $value) {
		?>
    <option <?php if ($value->contact_form_id == $recruitment->rec_contact_form) {
			echo 'selected';
		}
		?> value="<?php echo $value->contact_form_id; ?>"><?php echo $value->contact_form_type; ?></option>
                                                 <?php }
}
?>
                                        </select>
                            ...
                            <div class="col-sm-12 text-right">
                                <div class="form-group col-sm-12">
                                    <a href="javascript:editDraftRecruiment()" class="btn btn-warning margin-top-5"><?php echo lang('m_save'); ?> </a>
                                    <button class="btn btn-primary margin-top-5"><?php echo lang('em_edit_post_recruitment'); ?></button>
                            ...
                            <input type="hidden" name="idRec" value="<?php echo $recruitment->rec_id; ?>">
