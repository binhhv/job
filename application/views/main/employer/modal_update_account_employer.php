    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title"><?php echo lang('title_em_change_password');?></h3>
            ...
            <div class="modal-body">
                ...
                <form enctype="multipart/form-data" role="form" name="employer-account-update-form" id="employer-account-update-form" method="post">
                    <fieldset>
                         ...
                         <div class="row ">
                             <div class="form-group col-sm-12 error-em-change-password hide">
                          ...
                          <div class="row">
                             <div class="col-sm-12">
                                <div class="form-group text-right">
                                     <button type="submit" class="btn btn-primary"><?php echo lang('btn_change');?></button>
                                </div>
                            </div>
                        </div>
                    </fieldset>
