        ...
        <section class="content" ng-init="getDataRecruitmentCreate('<?php echo $countryGET->country_id;?>');">
          ...
          <div class="row" id="message-load-data">
            <div class="col-sm-12 text-center">
              <img class="img-responsive" style="margin:0 auto;" src="<?php echo base_url();?>assets/admin/dist/img/loading.gif">
            </div>
          </div>
          ...
          <div class="row hide" id="recruitment-create-error">
            ...
            <form style="background-color: #fff;" name="recruitmentCreateForm" class="hide" id="recruitmentCreateForm" novalidate ng-show="show_form">
            <fieldset>
                <div class="row">
                  <div class="col-sm-12">
      ...
      ng-model="rec.object_salary"></select>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="date" id="rec_job_time" name="rec_job_time" ng-model="rec.rec_job_time"
                                 placeholder="dd/MM/yyyy" min="1950-01-01" max="2050-12-31" required class="form-control" />
