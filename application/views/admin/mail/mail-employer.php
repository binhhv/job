<section class="content" ng-controller="mailEmployerController">
                 ...
                 <div class="box-body table-responsive no-padding"  ng-show="filteredItems > 0">
                  <table class="table table-hover table-striped hide" id="mailJobseekerTable" ng-init="getMailJobseeker();">
                    ...
                    <td class="text-center">
                      ...
                      <td class="text-left">({{data.employer_name | cut:true:10:' ...'}}){{data.email | cut:true:20:' ...'}}</td><!--{{($index + ((currentPage -1)* entryLimit)) + 1}}-->
                    </tr>
