  ...
  <div id="level-ctrl"  ng-controller="levelController">


<section class="content-header">
          <h1>
           Danh mục trình độ/năng lực.
          </h1>
          <ol class="breadcrumb">
            <li><a href="<?php echo base_url('admin');?>"><i class="fa fa-dashboard"></i> Trang chủ</a></li>
            <li class="active">Trình độ/Năng lực</li>
        ...
        <section class="content-header">
          <div class="row">
            ...
            <div class="col-md-12">
              <button class="btn btn-primary pull-right reload-province" ng-click="reloadLevel();" >tải lại dữ liệu</button></div>
          </div>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box province-box">
                <div class="box-header">
                  <div class="col-sm-6 col-xs-12">  <button class="btn btn-sm btn-info" ng-click="openModalCreateLevel('md')">tạo mới</button></div>
                ...
                <div class="box-body table-responsive no-padding"  ng-show="filteredItems > 0">
                  <table class="table table-hover table-striped hide" id="levelTable" ng-init="getLevel();">
                    <tr>
                    ...
                    <tr ng-repeat="data in filtered = (pagedItems | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
                      <td class="text-center">{{data.ljob_level}}</td><!--{{($index + ((currentPage -1)* entryLimit)) + 1}}-->
                      <td class="text-center">{{formatDate(data.ljob_created_at) | date: "dd/MM/yyyy"}}</td>


                      <td class="text-center">
                      <button class="btn btn-xs btn-warning" ng-click="openModalUpdateLevel('md',data)" >sửa</button>
                      <button class="btn btn-xs btn-danger" ng-click="openModalDeleteLevel('md',data)">xóa</button>
                      </td>
                    </tr>
