  ...
  <div id="level-ctrl"  ng-controller="welfareController">
...
<section class="content-header">
        ...
        <section class="content-header">
          <div class="row">
            ...
            <div class="col-md-12">
              <button class="btn btn-primary pull-right reload-province" ng-click="reloadWelfare();" >tải lại dữ liệu</button></div>
          </div>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box province-box">
                <div class="box-header">
                  <div class="col-sm-6 col-xs-12">  <button class="btn btn-sm btn-info" ng-click="openModalCreateWelfare('md')">tạo mới</button></div>
                ...
                <div class="box-body table-responsive no-padding"  ng-show="filteredItems > 0">
                  <table class="table table-hover table-striped hide" id="welfareTable" ng-init="getWelfare();">
                    <tr>
                     <th class="text-center">Icon</th>
                      <th class="text-center">Phúc lợi</th>
                    ...
                    <td class="text-center"><i ng-class="data.welfare_icon"></i></td>
                      <td class="text-center">{{data.welfare_title}}</td><!--{{($index + ((currentPage -1)* entryLimit)) + 1}}-->
                      <td class="text-center">{{formatDate(data.welfare_created_at) | date: "dd/MM/yyyy"}}</td>


                      <td class="text-center">
                      <button class="btn btn-xs btn-warning" ng-click="openModalUpdateWelfare('md',data)" >sửa</button>
                      <button class="btn btn-xs btn-danger" ng-click="openModalDeleteWelfare('md',data)">xóa</button>
                      </td>
                    </tr>
