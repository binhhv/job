          ...
          <div class="row invoice-info employer-info">
            <div class="col-sm-3 invoice-col">
              <div class="col-sm-12 p-relative">
                <?php if (isset($employer->employer_logo) && file_exists('upload/logo/' . $employer->employer_id . '/' . $employer->employer_logo_tmp)) {?>
                  <img class="img-responsive" src="<?php echo base_url() . 'upload/logo/' . $employer->employer_id . '/' . $employer->employer_logo_tmp?>" alt="<?php echo $employer->employer_name?>" />
                  <?php } else {?>
                  <img class="img-responsive" src="<?php echo base_url();?>upload/common/logo.png" alt="<?php echo $employer->employer_name?>" />
                 <?php }
?>
              </div>
            </div><!-- /.col -->
            <div class="col-sm-9 invoice-col">
              <div class="col-md-6 col-sm-6 col-xs-12">
               ...
               <div class="col-md-6 col-sm-6 col-xs-12">
                 ...
                 <b>Số điện thoại liên hệ:</b> <?php echo $employer->employer_contact_phone?><br>
                 <b>Số điện thoại di động liên hệ:</b> <?php echo $employer->employer_contact_mobile?><br>
               </div>
                ...
                <div class="text-center">Không có dữ liệu</div>
                  ...
                  <div class="tab-pane" id="tab_3" ng-controller="employerRecruitmentController">
                      ...
                      <div class="box no-box-shadow">
                        <div class="box-header">
                          <div class="col-sm-6 col-xs-12">
                           <button class="btn btn-success" ng-click="createEmployerRecruitment('<?php echo $employer->employer_id?>')">tạo tin tuyển dụng</button>&nbsp;
                           <button class="btn btn-info" ng-click="reloadEmployerRecruitment('<?php echo $employer->employer_id?>')">tải lại dữ liệu</button>
                         </div>
                           <div class="col-sm-12 col-xs-12"><div class="box-tools">
                            <div class="input-group search-box" style="width: 150px;">
                              <input type="text" name="table_search" ng-model="search" ng-change="filter()" class="form-control input-sm pull-right" placeholder="tìm kiếm">
                              <div class="input-group-btn">
                                <button class="btn btn-sm btn-default"><i class="fa fa-search"></i></button>
                          ...
                          <table class="table table-hover table-striped hide" id="employerRecruitmentTable" ng-init="getEmployerRecruitments('<?php echo $employer->employer_id?>')">
                            ...
                            <tr ng-repeat="data in filtered = (pagedItems | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit" data-id="{{data.account_id}}">
                              ...
                              <td class="text-center">
                                ...
                                <label class="btn btn-xs btn-success" ng-show="data.rec_is_approve == true">đã duyệt</label>
                              <!-- {{data.account_is_disabled}} -->
                              </td>
                              ...
                              <td class="text-center">
                              <button class="btn btn-xs btn-info" ng-click="modalDetailEmployerRecruitment('lg',data)" >chi tiết</button>
                              <button class="btn btn-xs btn-warning" ng-click="modalUpdateEmployerRecruitment('lg',data)" >sửa</button>
                              <button class="btn btn-xs btn-danger" ng-click="modalDeleteEmployerRecruitment('sm',data)">xóa</button>
                              </td>
                            </tr>
                            <!-- <tr>
                              <td>183</td>
