            ...
            <div class="col-xs-12">
              <div class="box province-box">
                <div class="box-header">
                  <div class="col-sm-6 col-xs-12">  <button class="btn btn-sm btn-info" ng-click="openModalCreateTitleSite('md',1)">tạo mới tiêu đề</button></div>
                ...
                <div class="box-body table-responsive no-padding"  ng-show="filteredItems > 0">
                  <table class="table table-hover table-striped hide" id="siteTable" ng-init="getTitleSite(1);">
                    <tr>
                    ...
                    <tr ng-repeat="data in filtered = (pagedItems | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
                      <td class="text-center">
                          <img ng-click="activeSite(data,0,1)" ng-show="data.config_is_active == 1" class="icon-checked-site" src="<?php echo base_url()?>assets/admin/dist/img/icons/icon_checked.png">
                          <img ng-click="activeSite(data,1,1)" ng-show="data.config_is_active == 0" class="icon-checked-site" src="<?php echo base_url()?>assets/admin/dist/img/icons/icon_unchecked.png">
                      </td>
                      ...
                      <button class="btn btn-xs btn-danger" ng-click="openModalDeleteTitleSite('md',data,1)">xóa</button>
                      </td>
                    </tr>
