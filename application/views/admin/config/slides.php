                       ...
                       <div class="col-sm-4 col-xs-6" ng-repeat="item in slideActive">
                          <div class="item-slide-selected">
                            <a class="a-item-slide-selected">
                               <img ng-click="removeSlide(0,item);"  class="icon-slide-selected" src="<?php echo base_url()?>assets/admin/dist/img/icons/icon_deleted.png">
                              <img class="img-item-slide" ng-src="{{base_url}}uploads/config/slide/{{item.config_data_json | jsonFile:false}}" >
                            </a>
                          </div>
                       </div>
              ...
              <div class="box province-box">
                <div class="box-header">
                  <div class="col-sm-6 col-xs-12">
                       <button class="btn btn-primary btn-sm reload-province" ng-click="reloadSlide(0);" >tải lại dữ liệu</button>
                      <button class="btn btn-sm btn-info" ng-click="openModalUploadSlide(0,'md')">upload hình slide </button>
                  </div>
                   <div class="col-sm-6 col-xs-12">
               ...
               <div class="box-body table-responsive no-padding"  ng-show="filteredItems > 0">
                  <table class="table table-hover table-striped hide" id="slideTable" ng-init="getSlide(0);">
                    <tr>
                      <th class=""></th>
                    ...
                    <tr ng-repeat="data in filtered = (pagedItems | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
                      <td class="">
                        <img class="td-item-logo" ng-src="{{base_url}}uploads/config/slide/{{data.config_data_json | jsonFile:false}}" />
                      ...
                      <button class="btn btn-xs btn-warning" ng-click="selectedSlide(0,data)" ng-disabled="data.config_is_active == 1 || data.disabledAction">Chọn</button>
                      <button class="btn btn-xs btn-danger" ng-click="openModalDeleteSlide(0,'md',data)" ng-disabled="data.config_is_active == 1 || data.disabledAction">xóa</button>
                      </td>
                    </tr>
