...
class Admin_log extends CI_Controller {
	...
	function __construct() {
		...
		$this->load->model('admin/Log_model', 'logModel');
	...
	function index() {
		$scripts = array(
			"assets/admin/angularjs/controller/log.controller.js", "assets/admin/angularjs/service/log.service.js");
		$head = $this->load->view('admin/head', array(), TRUE);
		$header = $this->load->view('admin/header', array(), TRUE);
		$content = $this->load->view('admin/log/index', array('user' => $this->session->userdata['user']), TRUE);
