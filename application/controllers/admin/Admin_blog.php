...
class Admin_blog extends CI_Controller {
	...
	function getBlog() {
		...
		$content = $this->load->view('admin/blog/blog', array(), TRUE);
	...
	function createBlog() {
		...
		//$this->form_validation->set_rules('blog_content', 'Nội dung blog', 'trim|required|min_length[10]|xss_clean');
		//$this->form_validation->set_rules('file_name', 'Hình ảnh blog', 'trim|required|xss_clean');
