$(function(){
	$("#femployer-create-recruitment").submit(function(event) {
        ...
        $.ajax({
            ...
            url: base_website + "employer/recruitment/create", //Where to make Ajax calls
            ...
            success: function(response) {
                ...
                if (status == 'errvalid') {
                   ...
                   // getCaptcha();
                    ...
                    window.location.href = '<?php echo base_url("employer/recruitments");?>'; //redirec to home page jobseeker
                }
            },
