<section ng-controller="employerRecruitmentController">
                ...
                <div class="row">
                    <div class="col-sm-12">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="controls">
                                    {{documentJobseeker.docon_reason_apply}}
                                </div>
                            </div>
                            <div class="form-group col-sm-6">
                                <label class="control-label" for="suburb">Mức lương </label>
                                <div class="controls">
                                    {{documentJobseeker.docon_salary}}
                                </div>
                            </div>
                            <div class="form-group col-sm-6">
