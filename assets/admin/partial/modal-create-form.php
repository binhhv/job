<section ng-controller="documentController">
    ...
    <div class="modal-body">
       ...
       placeholder="dd/MM/yyyy" min="1950-01-01" max="2013-12-31" required class="form-control" />
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="controls">
                                    <input type="text" only-digits name="phone" ng-model="docform.docon_phone" id="phone" class="form-control" required >
                                </div>
                            </div>
                            <div class="form-group col-sm-6">
                                <label class="control-label" for="suburb">Email</label><label class="text-danger" >*</label>
                                <div class="controls">
                                    <input type="email" name="phone" ng-model="docform.jobseeker_email" id="phone" class="form-control" >
                                </div>
                            </div>
                            <div class="form-group col-sm-6">
      ...
      ng-model="docform.object_level"></select>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <label data-ng-repeat="choice in docform.listCountries" class="col-sm-6" >
                                  <input  type="radio" ng-change="changeCountryCreateForm()" name="object_country" ng-model="docform.object_country" ng-value="choice.country_id" />
                                  {{choice.country_name}}
                                </label>
  ...
  <ui-select multiple ng-change="changeProvinceCreateForm()"  ng-model="docform.provinceSelected" theme="bootstrap" ng-disabled="disabled" sortable="true" close-on-select="false" >
    <ui-select-match placeholder="Chọn tỉnh thành">{{$item.province_name}} </ui-select-match>
                ...
                <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group text-right">
                                <button class="btn btn-success" ng-click="createForm(docform)" ng-disabled="updateFormForm.$invalid || disabled_modal || docform.provinceSelected.length == 0">Lưu</button>
