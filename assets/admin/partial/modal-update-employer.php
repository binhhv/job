<div ng-controller="employerController">
    <div class="modal-header">
        <h3 class="modal-title">Sửa nhà tuyển dụng  </h3> <!--{{rec.provinceSelected}}-->
        <h5>Các trường <label class="text-danger">(*)</label> là bắt buộc</h5>
    </div>
    <div class="modal-body">
            <form name="employerUpdateForm" novalidate>
            <fieldset>
                <div class="row">
                    <div class="col-sm-12">
                            <div class="form-group col-sm-12 no-padding-responsive">
                              <div class="col-sm-6 no-padding">
                                ...
                                <label class="control-label" for="firstname">Người đại diện</label>
                                <div class="controls">
                                    <input type="text" class="form-control" ng-model="employer.employer_admin_name" disabled>
                                </div>
                                <label class="control-label" for="firstname">Email</label>
                                <div class="controls">
                                    <input type="text" class="form-control" ng-model="employer.employer_admin_email" disabled>
                                </div>
                                </div>
                                ...
                                <div class="col-sm-12 no-padding-child image-preview">
                                  <img ng-src="{{employer.pathWebsite}}uploads/logo/{{employer.employer_id}}/{{employer.employer_logo_tmp}}" ng-show="employer.employer_logo" id="employer_logo_tmp">
  ...
  <!-- <oi-select
                ...
                <div class="row">
                        <div class="col-sm-12">
                            ...
                            <button class="btn btn-success" ng-click="updateEmployer(employer,logo)" ng-disabled="employerUpdateForm.$invalid || disabled_modal || fileTypeValidate || fileSizeValidate">Lưu</button>
