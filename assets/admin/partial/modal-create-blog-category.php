<section ng-controller="blogCategoryController">
    <div class="modal-header">
        <h3 class="modal-title">Tạo danh mục blog.</h3>
    </div>
    <div class="modal-body">
            <form name="createBlogCategoryForm" novalidate>
                <fieldset>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group text-right">
                                ...
                                <button class="btn btn-success" ng-click="createBlogCategory(category)" ng-disabled="createBlogCategoryForm.$invalid">Lưu</button>
