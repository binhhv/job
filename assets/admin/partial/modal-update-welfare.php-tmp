<section ng-controller="welfareController">
    <div class="modal-header">
        <h3 class="modal-title">Chỉnh sửa danh mục phúc lợi.</h3>
    </div>
    <div class="modal-body">
            <form name="updateWelfareForm" novalidate>
                <fieldset>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group text-right">
                                ...
                                <button class="btn btn-success" ng-click="updateWelfare(welfare)" ng-disabled="updateWelfareForm.$invalid">Lưu</button>
