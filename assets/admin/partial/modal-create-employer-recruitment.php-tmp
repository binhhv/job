<div ng-controller="employerRecruitmentController">
    <div class="modal-header">
        <h3 class="modal-title">Đăng tin tuyển dụng  </h3> <!--{{rec.provinceSelected}}-->
      ...
      ng-model="rec.object_career"></select>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <label data-ng-repeat="choice in rec.listCountrys" class="col-sm-6" >
                                  <input  type="radio" ng-change="changeCountryCreate()" name="rec_job_map_country" ng-model="rec.rec_job_map_country" ng-value="choice.country_id" />
                                  {{choice.country_name}}
                                </label>
      ...
      ng-model="rec.object_contact_form"></select>
                ...
                <div class="row">
                        <div class="col-sm-12">
                            ...
                            <button class="btn btn-success" ng-click="createEmployerRecruitment(rec)" ng-disabled="employerUpdateRecruitmentForm.$invalid || rec.provinceSelected.length == 0 || disabled_modal">Lưu</button>
