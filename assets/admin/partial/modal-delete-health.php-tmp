                ...
                <fieldset>
                    <div class="row">
                        <div class="col-sm-12 text-danger">
                            Mọi thông tin liên quan đến hồ sơ của ứng viên có thể bị thay đổi.
                        </div>
                        <div class="col-sm-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group text-right">
                                ...
                                <button class="btn btn-success" ng-click="deleteHealth(health);" ng-disabled="disabled_modal" >Xóa</button>
