<section ng-controller="contactFormController">
    <div class="modal-header">
        <h3 class="modal-title">Chỉnh sửa hình thức liên hệ.</h3>
    </div>
    <div class="modal-body">
            <form name="updateContactFormForm" novalidate>
                <fieldset>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group text-right">
                                ...
                                <button class="btn btn-success" ng-click="updateContactForm(contactform)" ng-disabled="updateContactFormForm.$invalid">Lưu</button>
