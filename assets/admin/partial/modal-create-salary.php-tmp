<section ng-controller="salaryController">
    <div class="modal-header">
        <h3 class="modal-title">Tạo mới danh mục mức lương.</h3>
    </div>
    <div class="modal-body">
            <form name="createSalaryForm" novalidate>
                <fieldset>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group text-right">
                                ...
                                <button class="btn btn-success" ng-click="createSalary(salary)" ng-disabled="createSalaryForm.$invalid">Lưu</button>
