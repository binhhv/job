<section ng-controller="provinceController">
    <div class="modal-header">
        <h3 class="modal-title">Tạo tỉnh thành</h3>
    </div>
    <div class="modal-body" id="province-modal">
            <form name="createprovinceForm" novalidate>
                <fieldset>
                    <div class="row">
      ...
      ng-model="province.objectRegion"></select>
                            ...
                            <div class="form-group col-sm-12" ng-init="loadMap(province.province_long,province.province_lat);">
                                ...
                                <div class="controls">
                                    ...
                                    <div class="text-center text-danger">Vui lòng chọn vị trí trong nước được chọn.</div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group text-right">
                                ...
                                <button class="btn btn-success" ng-click="createProvince(province);ok()" ng-disabled="createprovinceForm.$invalid || disabled_modal">Lưu</button>
